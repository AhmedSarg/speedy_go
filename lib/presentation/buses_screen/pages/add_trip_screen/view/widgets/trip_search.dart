            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: () {
                  setState(() {
                    isSearching = true;
                    widget.viewModel.getToSearchController.text = filteredList[index];
                  });
                },
                child: ListTile(
                  title: Text(filteredList[index],style: AppTextStyles.busesItemTextSearchStyle(context),),
                ),
              );
            },
          ),
          ...
          Center(
            child: SizedBox(
              ...
              child: AppButton(
                ...
                textStyle:
                AppTextStyles.busesItemTextBottonStyle(context),
