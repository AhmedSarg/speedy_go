...
class RegisterVerifyPhoneNumberBody extends StatelessWidget {
  RegisterVerifyPhoneNumberBody({
    super.key,
            ...
            Container(
              ...
              child: Column(
                children: [
                  Center(
                    child: Text(
                      AppStrings.registerScreenVerifyTitle.tr(),
                      style:
                  ...
                  Text(
                    AppStrings.registerScreenVerifyDescription.tr(),
                    style:
