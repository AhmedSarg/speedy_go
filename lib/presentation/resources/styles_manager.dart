...
TextStyle getThinStyle(
    {fontFamily = FontConstants.primaryEnglishFont, fontSize = FontSize.s12, required Color color, List<Shadow>? shadows}) {
...
TextStyle getMediumStyle(
    {fontFamily = FontConstants.primaryEnglishFont, double fontSize = FontSize.s12, required Color color, List<Shadow>? shadows}) {
